...
<template>
    ...
    <div
        class="relative px-6 py-6 text-black dark:text-gray-200 sm:max-h-[280px] overflow-y-hidden"
    >
        ...
        >
            ...
            >
                <MdiReload
                    class="text-2xl text-center text-darkBlue-600 dark:text-primaryOrange cursor-pointer"
                />
            </Link>
            <div class="w-full">
                ...
                <Progress
                    class="h-2"
                    :model-value="job_application.score.relavancy_score"
                />
            </div>
            <div class="w-full">
                ...
                <Progress
                    class="h-2"
                    :model-value="job_application.score.skill_score"
                />
            </div>
            <div class="w-full">
                ...
                <Progress
                    class="h-2"
                    :model-value="job_application.score.experience_score"
                />
            </div>
        </div>
