...
<template>
    <div class="md:h-screen md:flex md:flex-col" :class="state.mode">
                ...
                <div class="nav-header">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <Dropdown :contentClasses="['mt-1']">
                            ...
                            <template v-slot:content>
                                <div
                                    class="mt-2 py-2 shadow-xl bg-white dark:bg-primaryGray rounded text-sm"
                                >
                                    <div>
                                        <Link
        ...
        <div class="md:flex md:flex-grow md:overflow-hidden">
            <nav
                class="hidden md:block flex-col bg-darkBlue-800 dark:bg-primaryGray text-white flex-shrink-0 pb-12 pt-6 overflow-y-auto transition-all items-center"
